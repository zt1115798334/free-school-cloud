...
public interface UserService extends BaseService<User, Long> {
    ...
    UserOutputDTO findRoUserByUserId(Long userId);

    List<UserOutputDTO> findRoUserByUserId(List<Long> userIdList);

    Map<Long, UserOutputDTO> findMapRoUserByUserId(List<Long> userIdList);

    PageImpl<UserOutputDTO> findRoUser(UserInputDTO voUser);

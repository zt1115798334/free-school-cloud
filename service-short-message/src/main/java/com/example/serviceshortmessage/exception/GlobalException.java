package com.example.serviceshortmessage.exception;

import com.example.serviceshortmessage.base.ResultMessage;
import com.example.serviceshortmessage.base.SystemStatusCode;
...
public class GlobalException {
    ...
    public ResultMessage operationException(RuntimeException ex) {
        log.error(ex.getMessage());

...
import com.example.shiro.factory.StatelessWebSubjectFactory;
import com.example.shiro.filter.ShiroFilterChainManager;
import com.example.shiro.realm.ShiroModularRealmAuthenticator;
import com.example.shiro.realm.RealmManager;
...
public class ShiroBaseConfig {
    ...
    public SecurityManager securityManager(RealmManager realmManager) {
        ...
        securityManager.setAuthenticator(new ShiroModularRealmAuthenticator());
